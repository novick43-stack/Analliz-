        ...
        <section className="flex flex-col gap-12 pb-20">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div className="flex flex-col gap-4">
                    <h2 className="text-6xl font-black text-gray-900 tracking-tight leading-none">Conversión <span className="text-blue-600">Funnels</span></h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                {[
                    ...
                    <div key={i} className="bg-white rounded-[2.5rem] p-8 border border-gray-100 shadow-xl flex flex-col gap-4">
                        ...
                        <div>
                            ...
                            <h3 className="text-3xl font-black text-gray-900">{loading ? "..." : kpi.val}</h3>
                        </div>
                    </div>
                ))}
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2 bg-white rounded-[4rem] p-12 border border-gray-100 shadow-2xl">
                    <div className="flex items-center justify-between mb-16">
                        <div>
                            <h3 className="text-4xl font-black text-gray-900 italic tracking-tighter">Checkout Flow</h3>
                ...
                <div className="bg-gray-900 rounded-[4rem] p-12 shadow-2xl text-white flex flex-col justify-between">
                    <div>
                        <h3 className="text-2xl font-black mb-8 italic">Puntos de Fuga</h3>
                            ...
                            {[
                                ...
                                <div key={i} className="flex items-center gap-6 p-6 rounded-3xl bg-white/5 border border-white/5 hover:bg-white/10 transition-all">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-2xl font-black">{item.val} pedidos</p>
                                    </div>
                                </div>
                            ))}
                        </div>
