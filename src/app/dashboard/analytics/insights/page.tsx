    ...
    return (
        <section className="flex flex-col gap-12 pb-20">
            ...
            <div className="bg-white rounded-[4rem] p-12 border border-gray-100 shadow-2xl">
                <div className="flex items-center justify-between mb-16">
                    <div className="flex items-center gap-6">
                        ...
                        <div>
                            <h3 className="text-3xl font-black text-gray-900 tracking-tighter uppercase">Velocidad de Venta (SKUs)</h3>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                {/* AOV Chart */}
                <div className="lg:col-span-2 bg-gray-900 rounded-[4rem] p-12 shadow-2xl text-white">
                    <div className="flex items-center gap-6 mb-16">
                        <div className="w-16 h-16 rounded-3xl bg-white flex items-center justify-center text-3xl text-gray-900 shadow-xl">
                            <Layers />
                        </div>
                        <div>
                            <h3 className="text-3xl font-black tracking-tighter uppercase">Distribución de Ticket</h3>
                ...
                {/* Insight Summary */}
                <div className="bg-white rounded-[4rem] p-12 border border-orange-100 shadow-2xl shadow-orange-100/50 flex flex-col gap-10">
                    <div className="flex flex-col gap-4">
                        ...
                        {[
                            ...
                            <div key={i} className="flex gap-6 p-6 rounded-[2rem] bg-gray-50 hover:bg-white hover:shadow-lg transition-all border border-transparent hover:border-orange-50">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs font-black text-gray-700 leading-snug tracking-tight">{item.text}</p>
                                </div>
                            </div>
                        ))}
                    </div>
